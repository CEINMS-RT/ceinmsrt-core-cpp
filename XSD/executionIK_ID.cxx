...
const ExecutionIKType::Fc_optional& ExecutionIKType::
Fc () const
{
  return this->Fc_;
}

ExecutionIKType::Fc_optional& ExecutionIKType::
Fc ()
{
  return this->Fc_;
}
...
void ExecutionIKType::
Fc (const Fc_optional& x)
{
  this->Fc_ = x;
}

ExecutionIKType::Fc_type ExecutionIKType::
Fc_default_value ()
{
  return Fc_type (6);
}

const ExecutionIKType::externalLoadsXml_type& ExecutionIKType::
externalLoadsXml () const
{
  return this->externalLoadsXml_.get ();
}

ExecutionIKType::externalLoadsXml_type& ExecutionIKType::
externalLoadsXml ()
{
  return this->externalLoadsXml_.get ();
}
...
void ExecutionIKType::
externalLoadsXml (const externalLoadsXml_type& x)
{
  this->externalLoadsXml_.set (x);
}

void ExecutionIKType::
externalLoadsXml (::std::auto_ptr< externalLoadsXml_type > x)
{
  this->externalLoadsXml_.set (x);
}

const ExecutionIKType::ikTaskFilename_type& ExecutionIKType::
ikTaskFilename () const
{
  return this->ikTaskFilename_.get ();
}

ExecutionIKType::ikTaskFilename_type& ExecutionIKType::
ikTaskFilename ()
{
  return this->ikTaskFilename_.get ();
}
...
void ExecutionIKType::
ikTaskFilename (const ikTaskFilename_type& x)
{
  this->ikTaskFilename_.set (x);
}

void ExecutionIKType::
ikTaskFilename (::std::auto_ptr< ikTaskFilename_type > x)
{
  this->ikTaskFilename_.set (x);
}
...
ExecutionIKType (const ik_type& ik,
                 ...
                 const externalLoadsXml_type& externalLoadsXml,
                 const ikTaskFilename_type& ikTaskFilename)
: ::xml_schema::type (),
  ik_ (ik, this),
  id_ (id, this),
  ...
  port_ (port, this),
  Fc_ (this),
  externalLoadsXml_ (externalLoadsXml, this),
  ikTaskFilename_ (ikTaskFilename, this)
{
}
...
: ::xml_schema::type (x, f, c),
  ...
  Fc_ (x.Fc_, f, this),
  externalLoadsXml_ (x.externalLoadsXml_, f, this),
  ikTaskFilename_ (x.ikTaskFilename_, f, this)
{
}
...
: ::xml_schema::type (e, f | ::xml_schema::flags::base, c),
  ...
  port_ (this),
  Fc_ (this),
  externalLoadsXml_ (this),
  ikTaskFilename_ (this)
{
  if ((f & ::xml_schema::flags::base) == 0)
  {
    ::xsd::cxx::xml::dom::parser< char > p (e, true, false, false);
       ...
       ::xml_schema::flags f)
{
  for (; p.more_content (); p.next_content (false))
  {
    ...
    // externalLoadsXml
    //
    if (n.name () == "externalLoadsXml" && n.namespace_ ().empty ())
    {
      ::std::auto_ptr< externalLoadsXml_type > r (
        externalLoadsXml_traits::create (i, f, this));

      if (!externalLoadsXml_.present ())
      {
        this->externalLoadsXml_.set (r);
        continue;
      }
    }
    ...
    // ikTaskFilename
    //
    if (n.name () == "ikTaskFilename" && n.namespace_ ().empty ())
    {
      ::std::auto_ptr< ikTaskFilename_type > r (
        ikTaskFilename_traits::create (i, f, this));

      if (!ikTaskFilename_.present ())
      {
        this->ikTaskFilename_.set (r);
        continue;
      }
    }
...
operator= (const ExecutionIKType& x)
{
  if (this != &x)
  {
    ...
    this->port_ = x.port_;
    this->Fc_ = x.Fc_;
    this->externalLoadsXml_ = x.externalLoadsXml_;
    this->ikTaskFilename_ = x.ikTaskFilename_;
  }
