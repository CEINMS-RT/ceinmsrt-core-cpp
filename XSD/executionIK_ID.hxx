...
#ifndef CXX__EXECUTION_IK_ID_HXX
#define CXX__EXECUTION_IK_ID_HXX
...
class ExecutionIKType: public ::xml_schema::type
{
  ...
  // Fc
  //
  typedef ::xml_schema::int_ Fc_type;
  typedef ::xsd::cxx::tree::optional< Fc_type > Fc_optional;
  ...
  // externalLoadsXml
  //
  typedef ::xml_schema::string externalLoadsXml_type;
  typedef ::xsd::cxx::tree::traits< externalLoadsXml_type, char > externalLoadsXml_traits;

  const externalLoadsXml_type&
  externalLoadsXml () const;

  externalLoadsXml_type&
  externalLoadsXml ();
  ...
  void
  externalLoadsXml (::std::auto_ptr< externalLoadsXml_type > p);

  // ikTaskFilename
  //
  typedef ::xml_schema::string ikTaskFilename_type;
  typedef ::xsd::cxx::tree::traits< ikTaskFilename_type, char > ikTaskFilename_traits;

  const ikTaskFilename_type&
  ...
  void
  ikTaskFilename (::std::auto_ptr< ikTaskFilename_type > p);
  ...
  Fc_optional Fc_;
  ::xsd::cxx::tree::one< externalLoadsXml_type > externalLoadsXml_;
  ::xsd::cxx::tree::one< ikTaskFilename_type > ikTaskFilename_;
};
...
#endif // CXX__EXECUTION_IK_ID_HXX
