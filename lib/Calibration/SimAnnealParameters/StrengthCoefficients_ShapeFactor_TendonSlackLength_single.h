...
#ifndef StrengthCoefficients_ShapeFactor_TendonSlackLength_single_h
#define StrengthCoefficients_ShapeFactor_TendonSlackLength_single_h
...
class StrengthCoefficients_ShapeFactor_TendonSlackLength_single;

template<typename NMSmodelT>
std::ostream& operator<< (std::ostream& output, 
                const StrengthCoefficients_ShapeFactor_TendonSlackLength_single<NMSmodelT>& p);


template <typename NMSmodelT>
class StrengthCoefficients_ShapeFactor_TendonSlackLength_single {
public:
	StrengthCoefficients_ShapeFactor_TendonSlackLength_single(NMSmodelT& subject, std::vector< std::string >& dofToCalibrate);
    ...
    friend std::ostream& operator<< <> (std::ostream& output, 
                  const StrengthCoefficients_ShapeFactor_TendonSlackLength_single& p);
private:
    NMSmodelT& subject_;
...
#include "StrengthCoefficients_ShapeFactor_TendonSlackLength_single.cpp"
